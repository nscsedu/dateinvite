...
public class ProfileImage extends Activity {
    ...
    private Button btnSelect,btn_confirm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ProfileImage.this,InitCamera.class));
            }
        });

        pAttacher = new PhotoViewAttacher(ivImage);
        pAttacher.update();
       // ivImage.setOnTouchListener(new Touch());
        //ivImage.setOnTouchListener(new Touch(2f,6f));
    }
    ...
    private void selectImage() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                boolean result=Utility.checkPermission(ProfileImage.this);
