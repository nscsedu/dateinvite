...
public class IndividualInvitation extends AppCompatActivity {
    ...
    String sendstring="[invite-coffee-en]\n";
   ...
   // ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ind_coffe);
      ...
      /*  Bundle bundle = getIntent().getExtras();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* startActivity(new Intent(IndividualInvitation.this,Interaction.class));
                ...
                Intent intent = new Intent(IndividualInvitation.this, Interaction.class);
       ...
       sendinvitation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(IndividualInvitation.this, InviteNew1.class);
                intent.putExtra("search", search);
                intent.putExtra("token", token);
                intent.putExtra("mail",mail);
