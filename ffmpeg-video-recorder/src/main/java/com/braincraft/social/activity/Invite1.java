...
public class Invite1 extends AppCompatActivity {
...
public int message=1;
    ...
    public static TextView select,left1,right1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        left1=(TextView) findViewById(R.id.left);
        right1=(TextView) findViewById(R.id.right);
       ...
       /* imageView.setOnTouchListener(new OnSwipeTouchListener(MyActivity.this) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // back button pressed
                startActivity(new Intent(Invite1.this,Chat.class));
               // overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        ...
        sendinvitation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(Invite1.this, Interaction.class);
