...
public class Invite3 extends AppCompatActivity {
    ...
    public static TextView select,left3,right3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        left3=(TextView) findViewById(R.id.left);
        right3=(TextView) findViewById(R.id.right);
       ...
       /* imageView.setOnTouchListener(new OnSwipeTouchListener(MyActivity.this) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // back button pressed
                startActivity(new Intent(Invite3.this,LikedMe.class));
              //  overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        ...
        sendinvitation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                //DO YOUR CODE
               /* startActivity(new Intent(Invite3.this,Interaction.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);*/


                Intent intent = new Intent(Invite3.this, Interaction.class);
