...
public class Invite4 extends AppCompatActivity {
    ...
    public static TextView select,left4,right4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        left4=(TextView) findViewById(R.id.left);
        right4=(TextView) findViewById(R.id.right);
       ...
       /* imageView.setOnTouchListener(new OnSwipeTouchListener(MyActivity.this) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // back button pressed
                startActivity(new Intent(Invite4.this,ContactAdmin.class));
               // overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        ...
        sendinvitation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                //DO YOUR CODE
                /*startActivity(new Intent(Invite4.this,Interaction.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);*/


                Intent intent = new Intent(Invite4.this, Interaction.class);
