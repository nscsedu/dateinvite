...
import static com.braincraft.social.activity.Page_Activity1.city1;
import static com.braincraft.social.activity.Page_Activity1.date_list;
import static com.braincraft.social.activity.Page_Activity1.image_list;
import static com.braincraft.social.activity.Page_Activity1.mail;
import static com.braincraft.social.activity.Page_Activity1.message;
import static com.braincraft.social.activity.Page_Activity1.name1;
import static com.braincraft.social.activity.Page_Activity1.nameid;
import static com.braincraft.social.activity.Page_Activity1.token;
import static com.braincraft.social.activity.Page_Activity1.name11;
...
int itcount;
    ...
    public MyAdapter1(Context c, ArrayList<String> spacecrafts, ArrayList<String> ImgUrl, int itemcount) {
        this.c = c;
...
this.itcount=itemcount;
    ...
    public MyViewHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.new_message_list,parent,false);
        ...
        holder.nametxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* Intent i = new Intent(view.getContext(), Invite.class);
                ...
                view.getContext().startActivity(i); ImgUrl1

                ((Activity) view.getContext()).finish();*/

                String tmp_username,tmp_user;
                tmp_username= nameid[position];
                tmp_user=name1[position];
                ...
                Log.i(TAG, "remainder:" +  remainder);
                Intent i = new Intent(view.getContext(), chatmessage.class);

                i.putExtra("search",tmp_username);
                i.putExtra("username",tmp_user);
               // i.putExtra("profileimage",image_list[position]);
                i.putExtra("token",token);
                i.putExtra("mail",mail);

                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK); //add this line
                //  ((Page_Activity1) context).overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
