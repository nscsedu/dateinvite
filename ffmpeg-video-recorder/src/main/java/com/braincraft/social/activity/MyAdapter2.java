...
import static com.braincraft.social.activity.Page_Activity2.mail;
import static com.braincraft.social.activity.Page_Activity.name;
import static com.braincraft.social.activity.Page_Activity2.token;
//import static com.braincraft.social.activity.Page_Activity2.itemcount;
import static com.braincraft.social.activity.Page_Activity1.age1_list;
import static com.braincraft.social.activity.Page_Activity2.city1;
import static com.braincraft.social.activity.Page_Activity2.date_list;
import static com.braincraft.social.activity.Page_Activity2.message;
import static com.braincraft.social.activity.Page_Activity2.name1;
import static com.braincraft.social.activity.Page_Activity2.image_list;
import static com.braincraft.social.activity.Page_Activity2.name11;
...
int itcount;
    ...
    public MyAdapter2(Context c, ArrayList<String> spacecrafts,ArrayList<String> ImgUrl,int itemcount) {
        this.c = c;
    ...
    public MyViewHolder2 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.liked_new,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder2 holder, final int position) {
        ...
        holder.likedtoother.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
