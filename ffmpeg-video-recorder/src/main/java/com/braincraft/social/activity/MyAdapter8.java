...
import static com.braincraft.social.activity.Page_Activity8.city1;
import static com.braincraft.social.activity.Page_Activity8.date_list;
import static com.braincraft.social.activity.Page_Activity8.message;
import static com.braincraft.social.activity.Page_Activity8.name1;
import static com.braincraft.social.activity.Page_Activity8.image_list;
import static com.braincraft.social.activity.Page_Activity8.video_count;
import static com.braincraft.social.activity.Page_Activity8.video_list2;
...
public class MyAdapter8 extends RecyclerView.Adapter<MyViewHolder8>  {
    ...
    public MyAdapter8(Context c, ArrayList<String> spacecrafts,ArrayList<String> ImgUrl,int itemcount) {
        this.c = c;
    ...
    //INITIALIZE VH
    @Override
    public MyViewHolder8 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.video_message_all,parent,false);
    ...
    @Override
    public void onBindViewHolder(MyViewHolder8 holder, final int position) {

        Log.i(TAG, "position:" + i);
        if(video_list2[position]==1)
        {
holder.seenvideo.setBackgroundResource(R.drawable.viewed);
           // holder.seenvideo.setText("Viewes");
           // holder.seenvideo.setTextColor(Color.RED);
        }
        ...
        Log.i(TAG, "1name:" + name1[position]);
        Log.i(TAG, "1date:" + message[position]);
        Log.i(TAG, "1location:" + city1[position]);
        cnt++;
        if (j < image_list.size()) {
            ...
            //holder.thumbnail.setImageResource( mArray[j]);
            holder.nametxt.setText(name1[position]);
            Log.i(TAG, "name:" + name1[position]);
            Log.i(TAG, "date123:" + message[position]);
            // holder.age.setText(age1_list[j]);
           // holder.videocount.setText(video_count[j]);
            holder.count.setText(city1[j]);
            Log.i(TAG, "location:" + city1[j]);
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                video_list2[position]=1;
               /* Toast.makeText(view.getContext(), "Please check the number you entered",
                        Toast.LENGTH_LONG).show();*/
                Log.v("pos22:", Integer.toString(position));
                Intent i = new Intent(view.getContext(), video_play_all.class);
    ...
    public int getItemCount() {
       ...
       /* Log.i(TAG, "itemcountadapter:" + itemcountadapter);
        ...
        Log.i(TAG, "itcount_video:" + itcount);
        return itcount;
    }
}