...
public class Page_Activity2 extends AppCompatActivity
...
//public static String city;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Log.v("new_token2:",new_token2);
        //Log.v("new_mail2:",new_mail2);
      ...
      /*  col1.setOnClickListener(new View.OnClickListener() {
        ...
        layoutManager = new GridLayoutManager(Page_Activity2.this, 1);
      ...
      /*  settings = (ImageView) header.findViewById(R.id.settings);
        ...
        go = (TextView) header.findViewById(R.id.go);*/
         ...
         String url = "http://api.dateinvite.com/likes/liked.json";
      ...
      /*  videomessage.setOnClickListener(new View.OnClickListener() {
        ...
        firstpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Page_Activity2.this, Page_Activity.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // rv.setAdapter(new MyAdapter2(Page_Activity2.this, p.generatePage(currentPage),ImgUrl1));
                toggleButtons();
