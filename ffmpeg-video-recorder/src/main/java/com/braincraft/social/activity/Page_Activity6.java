...
public class Page_Activity6 extends AppCompatActivity
    ...
    public String new_token6,new_mail6;
    ...
    private TextView go,editprofile,col1,col3,contactad,unblock;
...
//public static String city;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  startActivity(new Intent(Page_Activity1.this,Page_Activity.class));
               ...
               /* Intent intent = new Intent(Page_Activity6.this,Page_Activity.class);
                ...
                Intent intent = new Intent(Page_Activity6.this,SettingsActivity.class);
        ...
        new_token6=pref.getString("token_key", null);
        new_mail6=pref.getString("mail_key", null);

      //  Log.v("new_token4:",new_token6);
       // Log.v("new_mail4:",new_mail6);
        ...
        layoutManager = new GridLayoutManager(Page_Activity6.this, 1);
      ...
      /*  settings = (ImageView) header.findViewById(R.id.settings);
        ...
        //checkblockuser();
        Log.i(TAG, "blockid1:" + block_id);
        if(block_id>0)
        {
            Log.i(TAG, "blockid2:" + block_id);
            checkblockuser();
        }

        String url = "http://api.dateinvite.com/blocks.json";
      ...
      /*  videomessage.setOnClickListener(new View.OnClickListener() {
        ...
        firstpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Page_Activity6.this, Page_Activity.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // rv.setAdapter(new MyAdapter6(Page_Activity6.this, p.generatePage(currentPage),ImgUrl1));
                toggleButtons();
        ...
        CustomJSONObjectRequest rq = new CustomJSONObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Log.v("Response_bl", response.toString());
                      ...
                      /*  try
                       ...
                       /* try
                        ...
                        try {
                            ...
                            JSONArray list = response.getJSONArray("blocks");
                            ...
                            if(list != null){
                                ...
                                for(int i = 0; i < list.length();i++){
                                    ...
                                    Log.v("blockid:", parentObject.getString("id"));
                                    age1_list[k]=elem.getString("id");
...
/*
                                ...
                                rv.setAdapter(new MyAdapter6(Page_Activity6.this, p.generatePage(currentPage),ImgUrl1,itemcount));
...
//                            response.getString("users");
    ...
    public void test()
    {
        Toast.makeText(getApplicationContext(), "Activity Call",
                Toast.LENGTH_LONG).show();
    }
    ...
    public void  checkblockuser()
    {
        ...
        String url_like = "http://api.dateinvite.com/blocks/remove.json";
        ...
        try {
           ...
           // jsonBody.put("username", editTextUserName.getText().toString());
            Log.i(TAG, "block_idfinal:" +block_id);
              jsonBody.put("user",block_id);
        ...
        JsonObjectRequest rq= new JsonObjectRequest(Request.Method.POST,  url_like,jsonBody, new Response.Listener<JSONObject>(){
            ...
            public void onResponse(JSONObject response) {
                ...
                Log.v("Responseblockupdate", response.toString());
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                HashMap<String, String> params = new HashMap<String, String>();
                Log.i(TAG, "editTextEmai4:" +    mail);
                Log.i(TAG, "editTextPassword4:" +token);
                //  String creds = String.format("%s:%s","and5@test.com","a224af585f97ef309cb15e28116f14ea");
