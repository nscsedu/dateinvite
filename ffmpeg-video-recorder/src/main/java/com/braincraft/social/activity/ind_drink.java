...
public class ind_drink extends AppCompatActivity {
    ...
    String sendstring="[invite-drink-en]\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ind_drink);
...
//           str_id = bundle.getString("id");
        ...
        invitemessage=(EditText) findViewById(R.id.invitedrink);
      ...
      /*  Bundle bundle = getIntent().getExtras();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* startActivity(new Intent(IndividualInvitation.this,Interaction.class));
                ...
                Intent intent = new Intent(ind_drink.this, Interaction.class);
        ...
        sendinvitation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(ind_drink.this, InviteNew1.class);
                intent.putExtra("search", search);
                intent.putExtra("token", token);
                intent.putExtra("mail",mail);
